    ...
    <header className="w-full fixed left-0 z-[100] bg-black text-white ease duration-500">
      <nav className="max-w-[1400px] flex items-center justify-between h-20 md:px-10 px-7 my-0 mx-auto">
        ...
        <div className="flex items-center justify-between">
          <ul
            className={`bg-black md:flex md:items-center md:py-0 py-6 absolute md:static md:z-auto z-[-8] left-0 w-full md:w-auto md:pl-0 pl-9 mr-5 transition-all duration-500 ease-in ${
        ...
        <div className="flex items-center gap-1 mr-9">
          {user && (
            <>
              ...
              <img src={PF+user.profilePic} className="w-[3rem] rounded-[50%]" alt="" />
